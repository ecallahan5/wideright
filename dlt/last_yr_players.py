...
def sourcename_resource(api_secret_key=dlt.secrets.value):
    ...
    url = "https://www49.myfantasyleague.com/{config.last_league_year}/export?TYPE=players&L={config.league_id}&APIKEY={config.mfl_api_key}&DETAILS=&SINCE=&PLAYERS=&JSON=1"
