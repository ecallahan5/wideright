...
def sourcename_resource(api_secret_key=dlt.secrets.value):
    ...
    url = f"https://{host}/{last_league_year}/export?TYPE=playerScores&L={league_id}&APIKEY={config.mfl_api_key}&W=YTD&YEAR=&PLAYERS=&POSITION=&STATUS=&RULES=&COUNT=&JSON=1"
