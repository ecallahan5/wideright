...
def sourcename_resource(api_secret_key=dlt.secrets.value):
    ...
    url = "https://www49.myfantasyleague.com/{config.league_year}/export?TYPE=playerScores&L={config.league_id}&APIKEY={config.mfl_api_key}&W=YTD&YEAR=&PLAYERS=&POSITION=&STATUS=&RULES=&COUNT=&JSON=1"
...
if __name__ == "__main__":
    ...
    pipeline = dlt.pipeline(
        pipeline_name='mfl_scores', destination='bigquery', dataset_name='scores'
    )
