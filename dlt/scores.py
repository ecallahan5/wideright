...
def sourcename_resource(api_secret_key=dlt.secrets.value):
    ...
    url = "https://www49.myfantasyleague.com/2024/export?TYPE=playerScores&L=59643&APIKEY=ahFi18iVvuWsx1SmPVDHZTEeF7ox&W=YTD&YEAR=&PLAYERS=&POSITION=&STATUS=&RULES=&COUNT=&JSON=1"
