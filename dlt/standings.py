...
def sourcename_resource(api_secret_key=dlt.secrets.value):
    ...
    url = "https://www49.myfantasyleague.com/{config.league_year}/export?TYPE=leagueStandings&L={config.league_id}&APIKEY={config.mfl_api_key}&COLUMN_NAMES=&ALL=&WEB=&JSON=1"
...
if __name__ == "__main__":
    ...
    pipeline = dlt.pipeline(
        pipeline_name='mfl_standings', destination='bigquery', dataset_name='standings'
    )
