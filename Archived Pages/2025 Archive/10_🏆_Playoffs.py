...
champ_df = pd.DataFrame(
     ...
     [{"seed": 6,"franchise_id":"0002","Champ":0.1116,"Runner-Up":0.1389,"3rd place":0.1366},
     {"seed": 3,"franchise_id":"0009","Champ":0.0701,"Runner-Up":0.1035,"3rd place":0.1168},
     {"seed": 5,"franchise_id":"0011","Champ":0.0651,"Runner-Up":0.0897,"3rd place":0.1105},
    {"seed": 4,"franchise_id":"0005","Champ":0.1642,"Runner-Up":0.1381,"3rd place":0.1647},
     {"seed": 1,"franchise_id":"0001","Champ":0.3219,"Runner-Up":0.2566,"3rd place":0.2328},
     {"seed": 2,"franchise_id":"0003","Champ":0.2671,"Runner-Up":0.2732,"3rd place":0.2386}]
 )
...
with st.expander("Click for Previews"):
     with st.container(border = True):
          ...
          col1.metric("Brooklyn Big Blue", "#6")
          col2.metric('Win %', "55%")
          col3.write("Prediction")
          col3.image(champ_df.loc[champ_df["seed"] == 6]["icon"].values[0])
          col4.metric('Win %', "45%")
          col5.metric("The Gurley Tates", "#3")
     with st.container(border = True):
          col1, col2, col3, col4, col5= st.columns(5)
...
with st.expander("Click for Bracket"):
     ...
     with col1:
          st.subheader("Wild Card", divider = True)
          with st.container(border = True):
               st.image(champ_df.loc[champ_df["seed"] == 6]["icon"].values[0])
          with st.container():
               st.write("")
          with st.container(border = True):
          ...
          st.divider()  
          with st.container(border = True):
               st.image(champ_df.loc[champ_df["seed"] == 5]["icon"].values[0])
          with st.container():
               st.write(" ")
          with st.container(border = True):
...
[{"seed": ,"franchise_id":"0004","Extra Pick":0.0286},
 {"seed": ,"franchise_id":"0007","Extra Pick":0.0840},
 {"seed": ,"franchise_id":"0003","Extra Pick":0.2589},
 {"seed": ,"franchise_id":"0012","Extra Pick":0.0791},
 {"seed": ,"franchise_id":"0006","Extra Pick":0.3939},
 {"seed": ,"franchise_id":"0008","Extra Pick":0.1555}]
)
...
with st.expander("Click for Bracket"):
     ...
     with col1:
          st.subheader("Wild Card", divider = True)
          with st.container(border = True):
               st.image(cons_df.loc[cons_df["seed"] == 6]["icon"].values[0])
          with st.container():
               st.write("")
          with st.container(border = True):
               st.image(cons_df.loc[cons_df["seed"] == 3]["icon"].values[0])
          st.divider()  
          with st.container(border = True):
               st.image(cons_df.loc[cons_df["seed"] == 5]["icon"].values[0])
          with st.container():
               st.write(" ")
          with st.container(border = True):
               st.image(cons_df.loc[cons_df["seed"] == 4]["icon"].values[0])
